...
<div class="bg-opacity-25 grid grid-cols-1 md:grid-cols-2 bg-white">
    <div class="p-6">
		...
		<div class="flex pt-8 sm:pt-0 justify-center">
                      <img src="/images/ssbt1.jpg" />
                </div>
...
<p>Vestibulum nisl magna, lacinia a urna id, maximus pulvinar purus. Aliquam bibendum a neque semper dictum. In hac habitasse platea dictumst. Quisque suscipit, odio vitae hendrerit aliquam, velit risus iaculis neque, eget iaculis nisi orci in eros. Vestibulum eget nisl ut odio convallis dapibus. Pellentesque accumsan aliquam ipsum ut porta. Phasellus molestie quis ipsum vel commodo.</p>
    ...
    <div class="p-6 border-t border-gray-200 md:border-l">
		...
		more information here
				...
				<p>Aliquam ultricies malesuada leo, pellentesque auctor ligula efficitur eleifend. Cras finibus pharetra elit, et sagittis massa rhoncus pharetra. Morbi eu enim sit amet dui suscipit tincidunt et sit amet eros. Suspendisse commodo fringilla faucibus. Sed cursus est a elit feugiat, ac scelerisque enim sollicitudin. Sed porta at tortor quis faucibus. Quisque laoreet, dui sed lacinia faucibus, ante dui commodo nisl, ut porta urna urna id ligula. Proin tempor arcu tortor, vitae facilisis turpis condimentum et. Phasellus lacinia faucibus interdum. Quisque nibh dolor, euismod id dignissim ac, eleifend vel tellus.
